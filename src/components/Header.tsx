...
import { Settings, ClipboardList, Calendar, Users } from "lucide-react";
...
export function Header() {
  ...
  const links = [
    ...
    { href: "/customers", label: "Patientenstamm", icon: Users },
  ];
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white shadow-lg shadow-[#1f90b2]/15 ring-1 ring-[#1f90b2]/10 transition-transform group-hover:scale-105">
              <Image src="/dz-icon.png" alt="Die Zahnärzte Logo" width={22} height={22} className="object-contain" />
            </div>
