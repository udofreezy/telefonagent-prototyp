...
export function TestCallButton({ phoneNumber, assistantId }: Props) {
  ...
  return (
    <div className="glow-teal rounded-2xl border border-[#0693e3]/20 bg-gradient-to-b from-[#0693e3]/5 to-transparent p-6">
      <div className="flex items-center gap-2 mb-4">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#0693e3] text-white">
      ...
      {phoneNumber && (
        <div className="mt-4 flex justify-center gap-2">
          ...
          <Button
            size="sm"
            className="rounded-xl bg-[#0693e3] text-white hover:bg-[#057cc0] border-0 text-xs"
