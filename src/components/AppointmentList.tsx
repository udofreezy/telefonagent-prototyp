            ...
            {appointment.callerPhone && (
              <div className="flex items-start gap-2 rounded-lg bg-muted/50 px-3 py-2">
                ...
                <div>
                  ...
                  <a href={`tel:${appointment.callerPhone}`} className="font-medium hover:text-[#0693e3] transition-colors">
                    {appointment.callerPhone}
                  </a>
                </div>
              </div>
            ...
            {appointment.callerEmail && (
              <div className="flex items-start gap-2 rounded-lg bg-muted/50 px-3 py-2">
                ...
                <div>
                  ...
                  <a href={`mailto:${appointment.callerEmail}`} className="font-medium hover:text-[#0693e3] transition-colors">
                    {appointment.callerEmail}
                  </a>
                </div>
              </div>
          ...
          <div className="rounded-2xl border border-border/50 bg-card p-5">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#0693e3]/10">
                <Calendar className="h-5 w-5 text-[#0693e3]" />
              </div>
              <div>
